...
public class StrategyPositionDto {
    ...
    public String isStock() {
        if (securityid.length() == 6 && (securityid.startsWith("002") || securityid.startsWith("000") || securityid.startsWith("300") || securityid.startsWith("200") || securityid.startsWith("900") || securityid.startsWith("600") || securityid.startsWith("60"))) {
            return "1";
