...
public abstract class QicoreDbUtil {
    public static NameParameterFacade nameParameterFacade = new NameParameterFacade("qicoredb");
    ...
    public static long insert(String sql, Object... param) {
        ...
        try {
            ...
            qicoreQueryRunner.fillStatement(pstmt, param);
            pstmt.executeUpdate();
            //返回自增加id
    ...
    public static List<Long> batchInsert(String sql, Object[][] params) {
        ...
        try {
            ...
            for (int i = 0; i < params.length; i++) {
                qicoreQueryRunner.fillStatement(pstmt, params[i]);
                pstmt.addBatch();
            }
            pstmt.executeBatch();
            rs = pstmt.getGeneratedKeys();
