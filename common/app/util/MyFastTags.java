...
public class MyFastTags extends FastTags {
    ...
    public static final String FLOAT_ZERO_VALUE = "0.OO";
    ...
    public static void _kvselect(Map<?, ?> args, Closure body, PrintWriter out,
        ...
        String serializedAttrs = play.templates.FastTags.serialize(args, "size", "keyname");
