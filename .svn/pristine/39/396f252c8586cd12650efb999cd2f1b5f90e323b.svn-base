...
public abstract class CommonUtils {
    ...
    public static  final DateFormat LOCAL_UTS_FORMAT = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'.'SSS'Z'");
    public static  final DateFormat LOCALFORMAT2 = new SimpleDateFormat(DATE_FORMAT_STR_ARR[1]);
        ...
        return new GsonBuilder().registerTypeAdapter(Date.class,new TypeAdapter<Date>() {
            public  Date read(JsonReader in) throws IOException{
              ...
              /*  if(value.contains("T") && value.contains("Z")){
                ...
                try{
                    LOCAL_UTS_FORMAT.setTimeZone(TimeZone.getTimeZone("UTC"));
                    return LOCAL_UTS_FORMAT.parse(value);
            ...
            public  void write(JsonWriter out, Date value)throws IOException{
              ...
              //  LOCALFORMAT2.setTimeZone(TimeZone.getTimeZone("UTC"));
                String dateFormatAsString = LOCALFORMAT2.format(value);
