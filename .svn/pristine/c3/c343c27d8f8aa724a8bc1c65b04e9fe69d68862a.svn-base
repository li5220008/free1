...
public class UserInfoBaseService {
    ...
    public  static List<UserRoleDto> findUserRole(long uid){
        ...
        return  QicDbUtil.queryQicDBBeanList(sql, UserRoleDto.class, uid);
    }
    public static  List<FunctionInfo> findRoleFunctionInfo(long rid){
        String sql = SqlLoader.getSqlById("findFunctionInfoByRoleId");
        List<FunctionInfo> functionInfoDtoList = QicDbUtil.queryQicDBBeanList(sql, FunctionInfo.class, rid);
