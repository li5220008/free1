...
public class SSOExportWithoutCheck extends Controller {
    ...
    public static void login(@Required(message = USER_NAME_REQUIRED) String u,
        ...
        doProcessLogin(u, crytoPwd, mac, pid);
    }
     ...
     */
    @Util
    private static void doProcessLogin(String u, String crytoPwd, String mac, Long pid) {
        ...
        UserInfo userInfo = UserInfo.findByAccount(u);
     ...
     */
    @NoTransaction
    public static void checkLoginToken(@Required(message = TOKEN_REQUIRED) String token, String clientId) {
