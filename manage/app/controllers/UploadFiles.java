...
public class UploadFiles extends BasePlayControllerSupport {
    ...
    public static void uploadUsers(File attachment,long uid) {
        ...
        LogInfosService.writeSystemLog(uid, SystemLoggerMessage.DO_LEAD_USERS, SystemLoggerMessage.LEAD_USERS, SystemLoggerMessage.TYPE);//写入操作日志
    ...
    public static void uploadStrage(File attachment,long uid) {
        ...
        LogInfosService.writeSystemLog(uid, SystemLoggerMessage.DO_UPLOAD_STRATEGYPACKAGE, SystemLoggerMessage.UPLOAD_STRATEGYPACKAGE, SystemLoggerMessage.TYPE);//写入操作日志
        renderJSON(getSampleResponseMap());
